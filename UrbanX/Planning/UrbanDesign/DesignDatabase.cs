...
namespace UrbanX.Planning.UrbanDesign
{
    ...
    public class SiteDataset
    {
        ...
        private static string dataDirectory = Path.Combine(defaultPath, "data");
        private static readonly string _xml = Path.Combine(dataDirectory, "UrbanDesign.xml");
        #endregion

        #region 旧数据
        //private static readonly string _xml = @"C:\Users\dell\Downloads\Formal\ProjectX\UrbanX\Data\UrbanDesign.xml";
        #endregion
