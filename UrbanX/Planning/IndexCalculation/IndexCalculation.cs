...
namespace UrbanX.Planning.IndexCalc
{
    public class IndexCalculation
    {
        ...
        public Dictionary<string, InfoFromXML_BB> Con_Buildings { get; set; }
        public Dictionary<string, InfoFromXML_BB> Con_Blocks { get; set; }
        public Dictionary<int, InfoFromXML_Population> PopulationType { get; set; }
        ...
        public double[] GarbageConsumption_BuildingSum(int[] layer, string[] function, double[] area)
        {
            ...
            for (int i = 0; i < len; i++)
            {
                ...
                //单位：千克/人
                var GConNum = Con_Buildings[function[i]]._GConsumption;
